  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-column align-items-center justify-content-between flex-grow-1 w-100 pb-3" style={{ marginTop: "15px" }}>
        ...
        >
          {/* Dashboard */}
          <NavItem to="/faculty/dashboard" icon="bi-speedometer2" label="Dashboard" location={location} />

          {/* Department Analytics */}
          <NavItem to="/faculty/analytics" icon="bi-graph-up-arrow" label="Dept Analytics" location={location} />

          {/* Low Confidence Queries */}
          <NavItem to="/faculty/queries" icon="bi-exclamation-triangle" label="Unanswered Queries" location={location} />

          {/* Submit FAQ Draft */}
          <NavItem to="/faculty/draft" icon="bi-file-earmark-plus" label="Submit FAQ Draft" location={location} />
        </ul>
