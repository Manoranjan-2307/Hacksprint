...
const S_Sidebar1 = () => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation List */}
      <div className="d-flex flex-column align-items-center justify-content-between flex-grow-1 w-100 pb-3" style={{ marginTop: "20px" }}>
        <ul
          className="nav flex-column align-items-center p-0 w-100"
          style={{ gap: "20px", display: "flex", flexDirection: "column" }}
        >
          {/* Ask Chatbot */}
          <NavItem to="/student1_1" icon="bi-chat-dots" label="Ask Chatbot" location={location} />

          {/* Chat History */}
          <NavItem to="/student1_2" icon="bi-clock-history" label="Chat History" location={location} />

          {/* My Feedback */}
          <NavItem to="/student1_3" icon="bi-chat-right-text" label="My Feedback" location={location} />

          {/* My Profile */}
          <NavItem to="/student1_4" icon="bi-person" label="My Profile" location={location} />
        </ul>
